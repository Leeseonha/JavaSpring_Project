...
public class ReviewControllerTests {
    ...
    public void createWithValidAttriutes() throws Exception {
        ...
        given(reviwService.addReview(1L, "John", 3, "Mat-it-da")).willReturn(Review.builder()
                .id(1004L)
                .build());
        ...
        verify(reviwService).addReview(eq(1l), eq("John"), eq(3), eq("Mat-it-da"));
    }
    ...
    public void createWithInvalidAttriutes() throws Exception {
        ...
        verify(reviwService, never()).addReview(any(), any(), any(), any());
    }
